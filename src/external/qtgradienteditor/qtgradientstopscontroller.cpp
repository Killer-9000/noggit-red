...
{
    QString h = QApplication::translate("qdesigner_internal::QtGradientStopsController", "H", 0, 0);
    QString s = QApplication::translate("qdesigner_internal::QtGradientStopsController", "S", 0, 0);
    QString v = QApplication::translate("qdesigner_internal::QtGradientStopsController", "V", 0, 0);

    m_ui->hLabel->setText(h);
    m_ui->sLabel->setText(s);
    m_ui->vLabel->setText(v);

    h = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Hue", 0, 0);
    s = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Sat", 0, 0);
    v = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Val", 0, 0);

    const QString hue = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Hue", 0, 0);
    const QString saturation = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Saturation", 0, 0);
    const QString value = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Value", 0, 0);
...
{
    QString r = QApplication::translate("qdesigner_internal::QtGradientStopsController", "R", 0, 0);
    QString g = QApplication::translate("qdesigner_internal::QtGradientStopsController", "G", 0, 0);
    QString b = QApplication::translate("qdesigner_internal::QtGradientStopsController", "B", 0, 0);

    m_ui->hLabel->setText(r);
    m_ui->sLabel->setText(g);
    m_ui->vLabel->setText(b);

    QString red = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Red", 0, 0);
    QString green = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Green", 0, 0);
    QString blue = QApplication::translate("qdesigner_internal::QtGradientStopsController", "Blue", 0, 0);
